    ...
    return ListenableBuilder(
      ...
      builder: (context, child) {
        ...
        if (controller.status == DownloadStatus.downloaded) {
          ...
          progressText = '100.0 % completed - ${controller.ressource.size}.0 of ${controller.ressource.size} MB';
        } 
        
        else if (controller.status == DownloadStatus.downloading) {
          iconData = Icons.downloading;
          progressText = '${(controller.progress * 100).toStringAsFixed(1)} % completed - ${(controller.ressource.size * controller.progress).toStringAsFixed(1)} of ${controller.ressource.size} MB';
        } 
        
        else {
          iconData = Icons.arrow_downward_rounded;
          progressText = '0.0 % completed - 0.0 of ${controller.ressource.size} MB';
        }
